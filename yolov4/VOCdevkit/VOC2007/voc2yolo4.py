...
#xmlfilepath=r'/home/data/52'
saveBasePath=r"/project/train/src_repo/yolov4/VOCdevkit/VOC2007/ImageSets/Main/"
...
all_xml = glob.glob("/home/data/*/*.xml")

# temp_xml =[]
# for a in all_xml:
#     temp_xml.append(os.path.split(a)[-1])
