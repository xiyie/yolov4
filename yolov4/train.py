...
if __name__ == "__main__":
    ...
    #----------------------------------------------------#
    anchors_path = '/project/train/src_repo/yolov4/model_data/yolo_anchors.txt'
    classes_path = '/project/train/src_repo/yolov4/model_data/voc_classes.txt'   
    #------------------------------------------------------#
    #   Yolov4的tricks应用
    ...
    loss_history = LossHistory("/project/train/log/")

    #----------------------------------------------------#
    #   获得图片路径和标签
    #----------------------------------------------------#
    annotation_path = '/project/train/src_repo/yolov4/VOCdevkit/VOC2007/ImageSets/Main/2007_train.txt'
    #----------------------------------------------------------------------#
